...
NEW_CSP='add_header Content-Security-Policy "default-src '\''self'\''; script-src '\''self'\'' '\''unsafe-inline'\'' '\''unsafe-eval'\'' https://js.stripe.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://sdk.mercadopago.com https://http2.mlstatic.com; style-src '\''self'\'' '\''unsafe-inline'\'' https://fonts.googleapis.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; font-src '\''self'\'' https://fonts.gstatic.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com data:; img-src '\''self'\'' data: https:; connect-src '\''self'\'' https: wss:; frame-src https://js.stripe.com https://hooks.stripe.com https://www.mercadopago.com.br https://www.mercadolibre.com; object-src '\''none'\''; base-uri '\''self'\''; form-action '\''self'\'';" always;'
